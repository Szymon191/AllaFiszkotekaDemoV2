        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "Free"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlashcardCategories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_FlashcardCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlashcardCategoryId = table.Column<int>(type: "integer", nullable: true),
                    GameMode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Points"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lobbies_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Lobbies_FlashcardCategories_FlashcardCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExampleUsage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LobbyParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "NotLearned"),
                    ...
                    ReviewInterval = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    EaseFactor = table.Column<decimal>(type: "numeric", nullable: false, defaultValue: 2.5m)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProgress_Flashcards_FlashcardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardCategories_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lobbies_FlashcardCategoryId",
                table: "Lobbies",
                column: "FlashcardCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LobbyParticipants_LobbyId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_FlashcardId",
                table: "UserProgress",
                column: "FlashcardId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_UserId_FlashcardId",
                table: "UserProgress",
